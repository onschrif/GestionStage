                            ...
                            @if ($e->user_id==$us->id&&$e->assignment==0)
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  <a href="{{ url('/main/EspaceResponsable/'. $us->id .'/downloadCv') }}" title="" ><button class="btn btn-dark btn-sm"><li><i  aria-hidden="true"></i> Télécharger</li></button></a>
                                ...
                                <td>
                                  ...
                                  <a href="{{ url('/main/EspaceResponsable/' . $stage->id .'/'. $us->id . '/acceptInternship') }}" title="" ><button class="btn btn-outline-success btn-sm"><li><i aria-hidden="true"></i> Accepter</li></button></a>
                                  <a href="mailto:{{$us->email}}" title="" ><button class="btn btn-dark btn-sm"><li><i aria-hidden="true"></i> Contacter</li></button></a>

                                  <a href="{{ url('/main/EspaceResponsable/' . $stage->id .'/'. $us->id . '/deleteRequest') }}"title="Refuse Request" ><button class="btn btn-danger btn-sm"><li><i class="fa fa-trash-o" aria-hidden="true"></i> Refuser</li></button></a>
