...
<body class="">
  <div class="wrapper ">
    <div class="sidebar" data-color="danger" data-background-color="black" data-image="public/template/assets/img/sidebar-1.jpg">
      <!--
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Modifier Stage</h4>
                  <p class="card-category">Veuillez Modifier Les Coordonnées Du Stage</p>
                </div>
                <div class="card-body">
                  ...
                  <form method="POST" action="updateInternship">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="date" class="form-control" name="startingDate" value="{{$internship->startingDate}}">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="date" class="form-control" name="endingDate" value="{{$internship->endingDate}}">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Description</label>
                          <textarea type="text" class="form-control" name="description" >{{$internship->description}}</textarea>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="type" value="{{$internship->type}}">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Domaine</label>
                          <input type="text" class="form-control" name="domaine" value="{{$internship->domaine}}">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="nbPersons" value="{{$internship->nbPersons}}">
                        </div>
                      </div>
                    </div>
                    <button type="submit" class="btn btn-danger pull-right">Modifier Stage</button>
                    <button  href="{{ url('/register') }}" class="btn btn-warning pull-right">Retour</button>
