                    ...
                    <table class="table">
                      ...
                      @foreach($internships as $internship)
                        <tr>
                          ...
                          <td>
                            <a href="{{ url('/main/EspaceEnseignant/' . $internship->id . '/updateInternship') }}" title="Update company" ><button class="btn btn-warning btn-sm"><li><i aria-hidden="true"></i> Modifier </li></button></a>
                            <a href="{{ url('/main/EspaceEnseignant/' . $internship->id . '/deleteInternship') }}" title="Delete company" onclick="return confirm(&quot;Confirm delete?&quot;)"><button class="btn btn-danger btn-sm"><li><i class="fa fa-trash-o" aria-hidden="true"></i> Supprimer</li></button></a>
