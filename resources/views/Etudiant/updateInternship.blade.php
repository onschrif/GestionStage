  ...
  <div class="wrapper ">
    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="{{ url('/main/EspaceEtudiant') }}">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand">Typography</a>
          </div>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="updateInternship">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="duration" value="{{$internship->duration}}">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <button type="submit" class="btn btn-danger pull-right">update Internship</button>
