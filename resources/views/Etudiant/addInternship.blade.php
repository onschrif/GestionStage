            ...
            <div class="col-md-11">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">proposer un Stage</h4>
                  <p class="card-category">Si Vous Avez Une Proposition De Stage, Veuillez Ajouter Soigneusement Les Coordonnées Du Stage</p>
                </div>
                <div class="card-body">
