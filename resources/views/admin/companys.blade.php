                    ...
                    <table class="table">
                      ...
                      @foreach($companys as $company)
                          <tr>
                            ...
                            <td>
                              <a href="{{ url('/admin/companys/' . $company->id . '/delete') }}" title="Delete company" onclick="return confirm(&quot;Confirm delete?&quot;)"><button class="btn btn-danger btn-sm"><li><i class="fa fa-trash-o" aria-hidden="true"></i> Refuse</li></button></a>
