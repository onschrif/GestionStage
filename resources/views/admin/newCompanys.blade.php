              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      @foreach($companys as $company)
                        <tr>
                          ...
                          <td>
                            <a href="{{ url('/admin/newCompanys/' . $company->id . '/accept') }}" title="Accept company"><button class="btn btn-success btn-sm"><li><i class="fa-li fa fa-check-square" aria-hidden="true"></i> Accept</li></button></a>
                            <a href="{{ url('/admin/newCompanys/' . $company->id . '/refuse') }}" title="Refuse company" onclick="return confirm(&quot;Confirm delete?&quot;)"><button class="btn btn-danger btn-sm"><li><i class="fa fa-trash-o" aria-hidden="true"></i> Refuse</li></button></a>
                    ...
                    <div class="pagination-wrapper">{!! $companys->appends(['search' => Request::get('search')])->render() !!} </div>
                  </div>
                </div>
              </div>
            </div>
